...
import { MAX_FILE_SIZE_MB, MAX_IMAGES } from "../../utils/constants";
      ...
      <div className="relative mb-4">
        <div
          ...
          <label
            ...
            <i
              style={{ fontSize: "2rem" }}
              className={`w-8 h-8 mb-2 pi pi-upload ${
                allImages.length < 3 ? "text-amber-600" : "text-gray-400"
              }`}
            />
            ...
            <input
              ...
              onChange={(e) =>
                ...
                } as unknown as FileUploadHandlerEvent)
              }
