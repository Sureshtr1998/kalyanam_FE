...
const Lander = () => {
    ...
    const renderForm = () => {
        if (currentForm === 'login') return <LoginForm setCurrentForm={setCurrentForm} />;

        return <RegistrationForm setCurrentForm={setCurrentForm} />;

    };
    return <div>
        <div className={`min-h-screen flex ${BG_COLOR} font-sans justify-center items-center`}>
            <div className="w-full max-w-7xl md:grid md:grid-cols-2 overflow-hidden shadow-2xl rounded-2xl m-4">
                ...
                <div className="relative overflow-hidden hidden md:flex items-center justify-center p-8 min-h-[650px]">
                    <div
                        ...
                        style={{ backgroundImage: `url('${seethaRama}')`, backgroundColor: '#FDE68A' }}
                        onError={(e: any) => { e.currentTarget.style.backgroundImage = 'none'; e.currentTarget.style.backgroundColor = '#FFD700'; }}
                    >
                ...
                <div className="flex flex-col justify-center items-center p-6 sm:p-8 lg:p-12 bg-white/95 backdrop-blur-sm min-h-[650px]">
                    ...
                    <div className="block md:hidden w-full mb-6">
                        <img
                            ...
                            onError={(e: any) => { e.currentTarget.onerror = null; e.currentTarget.src = "https://placehold.co/600x400/FFFBF5/D97706?text=Image+Missing"; }}
                        />
                    </div>
